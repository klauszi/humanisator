...
public class TestBFS08 {
	...
	public void setUp() throws Exception {
		...
		graph08 = OwnGraph.getInstanceFromFile(file);
	...
	public void testAllEdgesVisited() {
		OwnNode v6 = graph08.getNode("v6");
		bfs.run(v6);
		boolean allShown = graph08.realEdges()
